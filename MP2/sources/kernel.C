...
/*
    ...
    Console::puts("\n\nMemory inaccessible hole test-1, start frame : ");
    unsigned long hole_start_frame1 = process_mem_pool.get_frames((25 MB) / (4 KB));
    Console::puti(hole_start_frame1);
    Console::puts("\n\nMemory inaccessible hole test-2, start frame : ");
    unsigned long hole_start_frame2 = process_mem_pool.get_frames((15 MB) / (4 KB));
    Console::puti(hole_start_frame2);
    Console::puts("\n\nMemory inaccessible hole test-3, start frame : ");
    unsigned long hole_start_frame3 = process_mem_pool.get_frames((15 MB) / (4 KB));
    Console::puti(hole_start_frame3);
    ContFramePool::release_frames(hole_start_frame2);
    Console::puts("\n\nMemory inaccessible hole test-4, start frame : ");
    unsigned long hole_start_frame4 = process_mem_pool.get_frames((15 MB) / (4 KB));
    Console::puti(hole_start_frame4);
    ContFramePool::release_frames(hole_start_frame4);
*/
    /* -- NOW LOOP FOREVER */
